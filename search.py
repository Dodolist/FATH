...
from inspect_search import inspect_search_function, consonant_Alphabet, consonant_Korean, vowel_Alphabet, vowel_Korean
...
while True :
    ...
    inspect_char = inspect_search_function(search)


    if inspect_char==0: #영어로 검색하는 경우
        #From_Hangul_To_Alphabet(search)
        print('출력: '+temp_search)
